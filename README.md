...
- **[서원준 hnk1203]** | 메인화면 전체 디자인 및 제작, 플로팅 버튼 제작 및 기능 구현, 프로젝트 DB 구축 및 관리, 게시글 조회수 표시 및 좋아요 기능 구현, 프로젝트 발표
- **[이수정 soojeong77]** | 댓글 CRUD 구현, 프로젝트 발표 영상 촬영
- **[김존회 KimJohnhoi]**  | 로그인 및 회원가입 화면 제작, 회원 정보 수정 기능 구현, 로그인 시 메인화면으로 넘어가도록 구현, 마이페이지 제작
- **[강기민 KangGiMin]** | 게시글 CRUD 구현, 프로젝트 발표 PPT 제작
